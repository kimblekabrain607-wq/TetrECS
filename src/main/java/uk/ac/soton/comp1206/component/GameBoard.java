...
public class GameBoard extends GridPane {
    ...
    /**
     * The listener to call when the piece board is left clicked
     */
    ...
    protected void build() {
        ...
        //Add a listener for the right clicked.
        setOnMouseClicked((e) -> {
        ...
        //Add a listener for the left click on a pieceboard
        setOnMouseClicked((e) -> {
            logger.info("Left clicked on Piece Board");
            MouseButton mouseLeft = e.getButton();
            if(mouseLeft == MouseButton.PRIMARY){
    ...
    /**
     * Set the listener to handle an event when the right mouse button is clicked
     * @param listener listener to add
     */
    ...
    /**
     * Method to set the left clicked listener.
     * @param listener
     */
    public void setLeftClickedListener(LeftClickedListener listener){
